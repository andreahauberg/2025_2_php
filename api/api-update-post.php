...
try {
    ...
    // tjek useren er logged ind og ejer posten -- hent kun post_message
    $checkSql = "SELECT post_message FROM posts WHERE post_pk = :postPk AND post_user_fk = :userPk LIMIT 1";
