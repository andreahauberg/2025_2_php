...
// PDO
try{
  $dbUserName = 'andreahauberg_com';
  $dbPassword = '3GAdEFHb2p5rtxay6czD'; // root | admin
  $dbConnection = 'mysql:host=mysql97.unoeuro.com; dbname=andreahauberg_com_db; charset=utf8mb4'; 
