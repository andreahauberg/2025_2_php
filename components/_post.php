<article class="post">
    ...
    <div class="post-content">
        ...
        <div class="post-actions">
            ...
            <span class="action flip-btn" data-post-pk="<?php echo $post['post_pk']; ?>">
                <i id="like_<?php echo $post['post_pk']; ?>" class="<?php echo $post['is_liked_by_user'] ? 'fa-solid' : 'fa-regular'; ?> fa-heart"></i>
